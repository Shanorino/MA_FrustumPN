...
#    net = tf_util.conv2d(point_feat, 1024, [1,1],
#                     padding='VALID', stride=[1,1],
#                     bn=True, is_training=is_training,
#                     scope='conv5', bn_decay=bn_decay)
    ...
    concat_feat = tf.concat(axis=3, values=[point_feat, global_feat_expand])  #64+1024+1
...
def get_3d_box_estimation_v1_net(object_point_cloud, one_hot_vec,
    ...
    ''' 
    print ("initializing (3D box) PointNet")
